...
try: app_id = int(os.environ.get("app_id", "25833520"))
except Exception as app_id: print(f"⚠️ App ID Invalid {app_id}")
try: api_hash = os.environ.get("api_hash", "7d012a6cbfabc2d0436d7a09d8362af7")
except Exception as api_id: print(f"⚠️ Api Hash Invalid {api_hash}")
try: bot_token = os.environ.get("bot_token", "6650529779:AAHFfuRHrGWqSvu3oZCqO8Ll77rSyxQW6Nc")
except Exception as bot_token: print(f"⚠️ Bot Token Invalid {bot_token}")
try: custom_caption = os.environ.get("custom_caption", """<b>ɴᴀᴍᴇ: <code>{file_name}</code> \n\nJᴏɪɴ Nᴏᴡ: [⚡ Upload By ⚡](https://t.me/The_Silent_Teams)</b>""")
...
def start_buttons(bot, update):
  bot = bot.get_me()
  buttons = [[
   pyrogram.types.InlineKeyboardButton("Updates", url="t.me/The_Silent_Teams"),
...
print("Bot Created By https://t.me/THE_DS_OFFICIAL")
